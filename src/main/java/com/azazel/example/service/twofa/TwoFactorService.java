...
public class TwoFactorService {
    ...
    public boolean validateCode(String code, String secret) {
        try {
            ...
            // Allow codes within 3 time periods (90 seconds)
            ...
            String expectedCode = generator.generate(secret, timeWindow);
            log.info("Time window: {}, Input: {}, Expected: {}", timeWindow, code, expectedCode);
